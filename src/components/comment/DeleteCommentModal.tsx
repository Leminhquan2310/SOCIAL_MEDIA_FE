...
const DeleteCommentModal: React.FC<DeleteCommentModalProps> = ({ isOpen, onClose, onConfirm, isDeleting }) => {
    ...
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
      ...
      <div className="bg-white w-full max-w-md rounded-2xl shadow-2xl relative z-10 overflow-hidden animate-scale-up border border-rose-50">
        ...
        <div className="px-8 pb-8 text-center">
          ...
          <h3 className="text-xl font-bold text-gray-900 mb-2">Xác nhận xóa bình luận?</h3>
          <p className="text-gray-500 text-[14.5px] mb-8 leading-relaxed">
            Hành động này không thể hoàn tác. Bình luận và các phản hồi liên quan sẽ bị gỡ bỏ vĩnh viễn khỏi bài viết.
          </p>
